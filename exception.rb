...
class InvalidCordAndShip < StandardError
	def initialize(msg = 'Coordinate of ships and number of ship not match')
		super(msg)
	end
end

class InvalidCordAndMissile < StandardError
	def initialize(msg = 'Coordinate of ships and number of Missile not match')
		super(msg)
	end
end

class InvalidCordinates < StandardError
	def initialize(msg = 'Coordinate should be positive and valid')
		super(msg)
	end
end
